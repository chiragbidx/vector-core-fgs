...
const faqData = [
    ...
    {
        question: "Do the components work without Tailwind configured?",
        answer: "You can copy the generated CSS from the output file and use it directly, but enabling Tailwind gives you the best DX and theming support.",
    },
    {
        question: "Is there support for dark mode?",
        answer: "Yes. Utilities and tokens are organized so you can add a dark theme by toggling a parent class and defining the matching color variables.",
    },
    {
        question: "Can I use these assets in commercial projects?",
        answer: "All example assets are for demo use. Replace them with your licensed or self-hosted assets for production builds.",
    },
];
